...
export default function JobDetailsPage() {
  ...
  return (
    <div className="max-w-[730px] mx-auto  py-8">
      {/* Header Card */}
      <div className="bg-white dark:bg-slate-900 rounded-r-md rounded-bl-md rounded-tl-md md:rounded-tl-none  mb-8 pb-10 md:pb-0">
